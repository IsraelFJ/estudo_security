...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlerAccessDenied(AccessDeniedException erro) {
        return ResponseEntity
                .status(HttpStatus.FORBIDDEN) // Define o status HTTP como 403 Forbidden
                .body(Map.of("mensagem", "Acesso negado: você não tem permissão para acessar este recurso.", "detalhes", erro.getMessage()));
    }
